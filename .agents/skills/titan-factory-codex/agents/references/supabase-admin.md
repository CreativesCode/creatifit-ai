# Supplemental role recipes

The native TOML role governs scope and available capabilities. These inherited examples require project/version verification and do not configure tools or authorize actions. Provider names in examples are optional.
