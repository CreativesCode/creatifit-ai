      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="p-6 text-center bg-surface border-border">
            ...
            <div className="text-muted">Planes Creados</div>
          </Card>
          <Card className="p-6 text-center bg-surface border-border">
            <div className="text-3xl font-bold text-accent mb-2">
              {stats.totalSessions}
            </div>
            <div className="text-muted">Sesiones Completadas</div>
          </Card>
          <Card className="p-6 text-center bg-surface border-border">
            <div className="text-3xl font-bold text-secondary mb-2">
              {stats.totalExercises}
            </div>
            <div className="text-muted">Ejercicios Disponibles</div>
          </Card>
        </div>

        {/* Acciones Rápidas */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold text-txt mb-6 text-center">
            Acciones Rápidas
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {quickActions.map((action, index) => (
              <Card 
                key={index} 
                className="p-6 bg-surface border-border hover:shadow-lg transition-shadow cursor-pointer"
        ...
        {stats.totalPlans === 0 && (
          <Card className="p-8 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-txt mb-4">
                ¡Bienvenido a CreatiFit AI!
              </h3>
              <p className="text-muted mb-6 max-w-2xl mx-auto">
                Comienza tu viaje de fitness creando tu primer plan de entrenamiento personalizado. 
                Nuestra IA analizará tus objetivos, nivel y preferencias para crear el plan perfecto para ti.
              </p>
              <Button 
